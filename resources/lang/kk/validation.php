...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'levels' => [
            'required' => 'Кем дегенде 1 деңгей таңдауыңыз қажет',
        ],
        'conf_topic' => [
            'required' => 'Конференцияның тақырыбын енгізіңіз'
        ],
        'course_id' => [
        ...
        'start_date' => [
            'after_or_equal' => 'Сабақ кестесінің басталу күні бүгінгі күнге тең немесе кейінгі болуы керек.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'school_email'          => 'Мектептің электрондық поштасы',
        'first_name'            => 'Атыңыз',
        'last_name'             => 'Тегіңіз',
        'login'                 => 'Логин', 
        'iin'                   => 'ЖСН',
        ...
        'full_school_name'      => 'Мектептің толық атауы',
        ...
        'lesson_price'          => 'Бір сабақтың құны',
