...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'sentences_count' => [
            'min' => 'Минимальное количество выбранных предложений должно быть :min',
        ],
        'sections_count' => [
        ...
        'seconds_per_sentence' => [
            'required' => 'Укажите количество секунд, отведенное на поиск каждого предложения',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'sentence_kk'           => 'Перевод предложения на казахском языке',
        'sentence_ru'           => 'Перевод предложения на русском языке',
