...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'levels' => [
            'required' => 'Выберите как минимум один из уровней',
        ],
        'conf_topic' => [
            'required' => 'Укажите тему конференции'
        ],
        'course_id' => [
        ...
        'seconds_per_sentence' => [
            'required' => 'Укажите количество секунд, отведенное на поиск каждой фразы',
        ],
        'seconds_per_section' => [
        ...
        'start_date' => [
            'after_or_equal' => 'Дата начала расписания должна быть равна сегодняшней или поздней.',
        ],
    ],
