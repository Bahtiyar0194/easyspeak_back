...
Route::group([
    ...
    Route::group([
        ...
        Route::group(['middleware' => ['auth:sanctum']], function () {
            ...
            Route::post('/delete/{uuid}', [ConferenceController::class, 'delete']);
            ...
            Route::post('/save_settings', [ConferenceController::class, 'save_settings']);
        });
    });
    ...
    //         Route::get('/set_lesson_progress', [TaskController::class, 'set_lesson_progress']);
    // });
});